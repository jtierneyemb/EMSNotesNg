(function () {
  ...
  /** @ngInject */
  function AuthenticationService($http, $cookieStore, $rootScope, $log) {
    var service = this;
    ...
    function loadCredentials() {
      ...
      if ($rootScope.globals.currentUser) {
        $http.defaults.headers.common['X-Embarcadero-Session-Token'] = $rootScope.globals.currentUser.token; // jshint ignore:line
      }
      changed();
    }
